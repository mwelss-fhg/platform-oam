...
# Images
export ELASTICSEARCH_IMAGE=acumos-elasticsearch:4.0.4
export LOGSTASH_IMAGE=acumos-logstash:4.0.4
export KIBANA_IMAGE=acumos-kibana:4.0.4
export ELK_CLIENT=elk-client:4.0.4
