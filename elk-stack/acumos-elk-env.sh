...
# Images
export ELASTICSEARCH_IMAGE=acumos-elasticsearch:4.0.1
export LOGSTASH_IMAGE=acumos-logstash:4.0.1
export KIBANA_IMAGE=acumos-kibana:4.0.1
export ELK_CLIENT=elk-client:4.0.1
